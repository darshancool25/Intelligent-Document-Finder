...
# The function takes a string as a parameter, and returns the number of vacancies after parsing the string(JD/CV)
def getVacancy(s):
    # Following are the set of words which can act as prefix for number of vacancies. You may add other words as per your convinience
